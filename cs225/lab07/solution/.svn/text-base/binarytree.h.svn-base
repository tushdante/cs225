...
class BinaryTree
{
	...
	const Node * leftMost (const Node * subRoot) const;
	const Node * rightMost(const Node * subRoot) const;
	Node * mirror(Node * subRoot);
	void printPaths(const Node * node, vector<T> & path) const;

...
public:
   ...
   //                   endList - a reference to a previously allocated
   //                      List object, which must initially be empty
   //                      and is eventually filled with the latter part
   //                      of the current list
   //    - puts in endList the portion of the current list from

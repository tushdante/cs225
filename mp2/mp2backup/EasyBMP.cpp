...
* Modified 9/25 by Daniel Hoodin for CS225       *
*   - removed unused variable ZeroWORD           *
*                                                *
*************************************************/
...
BMP::BMP(BMP const & rhs)
{
   ...
   if (rhs.MetaData1) {
      MetaData1 = new ebmpBYTE[SizeOfMetaData1];
   ...
   if (rhs.MetaData2) {
       MetaData2 = new ebmpBYTE[SizeOfMetaData2];
...
bool BMP::Write32bitRow( ebmpBYTE* Buffer, int BufferSize, int Row ) const
{ 
 int i;
 if( Width*4 > BufferSize )
 { return false; }
...
bool BMP::Write24bitRow( ebmpBYTE* Buffer, int BufferSize, int Row ) const
{ 
 int i;
 if( Width*3 > BufferSize )
 { return false; }
...
bool BMP::Write8bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row ) const
{
 int i;
 if( Width > BufferSize )
 { return false; }
...
bool BMP::Write4bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row ) const
{ 
...
bool BMP::Write1bitRow(  ebmpBYTE* Buffer, int BufferSize, int Row ) const
{ 
...
ebmpBYTE BMP::FindClosestColor( RGBApixel const & input ) const
{
 using namespace std;
